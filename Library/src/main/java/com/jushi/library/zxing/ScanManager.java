...
import com.jushi.library.zxing.camera.CameraManager;
import com.jushi.library.zxing.decode.DecodeThread;
import com.jushi.library.zxing.decode.PhotoScanHandler;
import com.jushi.library.zxing.decode.RGBLuminanceSource;
import com.jushi.library.zxing.utils.BeepManager;
import com.jushi.library.zxing.utils.BitmapUtil;
import com.jushi.library.zxing.utils.CaptureActivityHandler;
import com.jushi.library.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback {
    ...
    public static final int BARCODE_MODE = 0X100; //条形码
    public static final int QRCODE_MODE = 0X200;  //二维码
    public static final int ALL_MODE = 0X300;  //条形码或二维码(全部)
    ...
    public ScanManager(Activity activity, SurfaceView scanPreview, View scanContainer,
        ...
        TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f,
                Animation.RELATIVE_TO_PARENT, -0.1f, Animation.RELATIVE_TO_PARENT,
                0.9f);
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        listener.scanResult(rawResult.getText(), bundle);
    }
...
//				Hashtable<DecodeHintType, String> hints = new Hashtable<DecodeHintType, String>();
            ...
            try {
                RGBLuminanceSource source = new RGBLuminanceSource(photo_path2);
