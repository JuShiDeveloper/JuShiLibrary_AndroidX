...
public class SelectableRoundedImageView extends ImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_riv_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_left_top_corner_radius, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_right_top_corner_radius, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_left_bottom_corner_radius, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_right_bottom_corner_radius, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_border_width, -1);
        if (mBorderWidth < 0) {
        ...
        mMutateBackground = a.getBoolean(R.styleable.SelectableRoundedImageView_riv_mutate_background, false);
        mIsOval = a.getBoolean(R.styleable.SelectableRoundedImageView_sriv_oval, false);

        final int tileMode = a.getInt(R.styleable.SelectableRoundedImageView_riv_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.SelectableRoundedImageView_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.SelectableRoundedImageView_riv_tile_mode_y, TILE_MODE_UNDEFINED);
     ...
     * width.
     *
     * @return if this {@link SelectableRoundedImageView} is set to oval.
     */
     ...
     *
     * @param oval if this {@link SelectableRoundedImageView} should be oval.
     */
    ...
    /**
     * Set whether the {@link SelectableRoundedImageView} should round the background drawable according to
