package com.jushi.library.customView.mzbanner;
...
import com.jushi.library.customView.mzbanner.transformer.CoverModeTransformer;
import com.jushi.library.customView.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.drawable.mz_indicator_normal,R.drawable.mz_indicator_selected};
