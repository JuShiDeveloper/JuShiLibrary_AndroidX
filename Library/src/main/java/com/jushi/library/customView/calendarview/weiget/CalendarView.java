package com.jushi.library.customView.calendarview.weiget;
...
import com.jushi.library.customView.calendarview.bean.AttrsBean;
import com.jushi.library.customView.calendarview.bean.DateBean;
import com.jushi.library.customView.calendarview.listener.CalendarViewAdapter;
import com.jushi.library.customView.calendarview.listener.OnMultiChooseListener;
import com.jushi.library.customView.calendarview.listener.OnPagerChangeListener;
import com.jushi.library.customView.calendarview.listener.OnSingleChooseListener;
import com.jushi.library.customView.calendarview.listener.OnStartStopChooseListener;
import com.jushi.library.customView.calendarview.utils.CalendarUtil;
import com.jushi.library.customView.calendarview.utils.SolarUtil;
...
public class CalendarView extends ViewPager {
    ...
    private OnStartStopChooseListener startStopChooseListener;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.CalendarView_manual_rolling) { //是否允许手动滑动
                mAttrsBean.setManualRolling(ta.getBoolean(attr, false));
            }
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        return mAttrsBean.isManualRolling() ? super.onTouchEvent(ev) : mAttrsBean.isManualRolling();
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        return mAttrsBean.isManualRolling() ? super.onInterceptTouchEvent(ev) : mAttrsBean.isManualRolling();
    }
    ...
    public void setOnStartStopChooseListener(OnStartStopChooseListener startStopChooseListener) {
        this.startStopChooseListener = startStopChooseListener;
    }

    public OnStartStopChooseListener getStartStopChooseListener() {
        return startStopChooseListener;
    }
    ...
    public void today() {
        ...
        if (mAttrsBean.getChooseType() == 2) { //选择起止时间模式事跳转到今天，不选中当天日期
